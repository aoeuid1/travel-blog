...
`,
  ...
  },
  {
    ...
    {{image:walls-of-constantinople-2}}
      ...
      <p> The best way to see the walls is to start from the <a href="https://maps.app.goo.gl/WSK16YbU6Xb5mKvL8" target="_blank">Yedikule Fortress</a> on the southern end of the walls, and follow the walls northwards. Yedikule Fortress and some of the gates are designed for tourists, but much of the path along the walls follows a small road with some industrial activity alongside it. It was also a pretty long trek, so unless you're like me and really enjoy walking, you might prefer to go by taxi or find a tour group to drive you to key sites.</p>

      {{image:walls-of-constantinople-3}}
      {{image:walls-of-constantinople-4}}
      <p> <a href="https://maps.app.goo.gl/DxQtP7BNZu999ccC9" target="_blank">Sosyal Tesisleri</a> is a chain of government sponsored, non profit restaurants opened to ensure people can still enjoy a nice meal despite the tourism-driven inflation in Istanbul. This one, near the <a href="https://maps.app.goo.gl/ewpwT4tLS3teMkYz5" target="_blank">Belgrade Gate (Belgradkapi)</a>, is part of a push to revive this area. At these restaurants, you can find local Turkish fare at prices 30-50% less than an equivalent restaurant. The Belgrade Gate and nearby walls are also the subject of extensive restoration efforts. </p>
      {{image:walls-of-constantinople-5}}


      <p> The <a href="https://maps.app.goo.gl/Mf8LneY47iygH3y49" target="_blank">Gate of St. Romanus</a>, located in a low point in the valley, was the weak point in the walls of Constantinople. On 29 May 1453, after weeks of bombardment, Ottoman cannons finally opened up an opening here. As Ottoman janissaries charged into the gap, in desperation, the last Byzantine emperor Constantine XI Palaiologos stripped off his regalia and charged into the melee here. Despite his heroic last stand, he was never seen again. With him, the city fell, the Byzantine empire fell, and the Roman empire was no more. </p>
      `,
    location: {
      lat: 41.026,
      lng: 28.922,
  ...
  },
  {
    ...
    content: `
      <p><a href="https://www.google.com/maps/place/Gori,+Georgia/" target="_blank">Gori</a>, a small city in Georgia, holds the controversial distinction of being the birthplace of Joseph Stalin, Soviet leader from 1924-1953. Dominating the town square is <a href="https://maps.app.goo.gl/Nv4E8esBWtjHbRdRA" target="_blank">the Joseph Stalin Museum</a>, a shrine dedicated to his life and accomplishments.</p>
