...
`,
  ...
  },
  {
    ...
    content: `
      ...
      <p>In my opinion, the Stalin Museum was very worth visiting despite the historical omissions: not as a place to find an accurate history lesson about Stalin's life, but more as a fascinating look at how history is written and remembered. The museum paints a believable, cohesive view of his life, and if you visited the museum without outside knowledge of Stalin's controversial policies, I believe the museum would convince you Stalin was a humble man who rose up from a difficult upbringing to save his country from war and become a national hero.</p>
